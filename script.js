...
function crud(event){
    ...
    axios.post("https://crudcrud.com/api/07d848d4014c4c8c912ee1b3fdb64215/ecom",obj)
    .then((res)=>{
        showuser(res.data)
...
axios.get("https://crudcrud.com/api/07d848d4014c4c8c912ee1b3fdb64215/ecom")
.then((res)=>{
...
function showuser(obj){
    ...
    function deleteuser(){
        axios.delete(`https://crudcrud.com/api/07d848d4014c4c8c912ee1b3fdb64215/ecom/${obj._id}`)
        .then(()=>{
